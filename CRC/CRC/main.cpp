...
void division(char *message, char *generator, char *remainder, int m_len,
              int g_len, int r_len, int startptr) {
...
int main() {
  ...
  if (myfile.is_open()) {
    ...
    division(new_message, polynomial, remainder, message_size, k_len, r_len,
             tempptr);
